                ...
                <div class="col-12">
                    <div class="">
                        <div class="card-body" style="background-color: #FFFFFF;">
                            <h4 class="card-title text-muted">DATA FORM PESERTA BIMBEL PRIMAGAMA</h4>
                            <form action="" class="form-sample" method="POST" enctype="multipart/form-data">
                                <p class="card-description text-warning"> Data Pribadi</p>
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="kelas" class="col-sm-3 col-form-label text-muted">Kelas</label>
                                            <div class="col-sm-9">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="jenis_kelamin" class="col-sm-3 col-form-label text-muted">Jenis Kelamin</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="nama" value="<?= $data_pendaftar['jenis_kelamin']; ?>" class="form-control text-muted" style="background-color:#F0EBE3" id="nama" placeholder="Nama" disabled />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="nama" value="<?= $data_pendaftar['tanggal_lahir']; ?>" class="form-control text-muted" style="background-color:#F0EBE3" id="nama" placeholder="Nama" disabled />
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="no_hp" class="col-sm-3 col-form-label text-muted">No Hp</label>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="agama" class="col-sm-3 col-form-label text-muted">Agama</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="nama" value="<?= $data_pendaftar['agama']; ?>" class="form-control text-muted" style="background-color:#F0EBE3" id="nama" placeholder="Nama" disabled />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="kecamatan" class="col-sm-3 col-form-label text-muted">Kecamatan</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="nama" value="<?= $data_pendaftar['kecamatan']; ?>" class="form-control text-muted" style="background-color:#F0EBE3" id="nama" placeholder="Nama" disabled />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="program_bimbel" class="col-sm-3 col-form-label text-muted">Program Bimbel</label>
                                            <div class="col-sm-9">
                                            
          
                                                <input type="text" name="nama" value="<?= $data_pendaftar['program_bimbel']; ?>" class="form-control text-muted" style="background-color:#F0EBE3" id="nama" placeholder="Nama" disabled />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="biaya_bimbel" class="col-sm-3 col-form-label text-muted">Biaya Bimbel</label>
                                            <div class="col-sm-9">
                                            <input type="text" name="nama" value="<?= $data_pendaftar['harga']; ?>" class="form-control text-muted" style="background-color:#F0EBE3" id="nama" placeholder="Nama" disabled />
                    ...
                    <form class="form-sample">
                        <p class="card-description text-warning">Data Orang tua </p>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group row">
                                    <label for="nama_ayah" class="col-sm-3 col-form-label text-muted">Nama Ayah</label>
                                    <div class="col-sm-9">
                            ...
                            <div class="col-md-4">
                                <div class="form-group row">
                                    <label for="nama_ibu" class="col-sm-3 col-form-label text-muted">Nama Ibu</label>
                                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group row">
                                    <label for="pekerjaan_ayah" class="col-sm-3 col-form-label text-muted">Pekerjaan Ayah</label>
                                    <div class="col-sm-9">
                            ...
                            <div class="col-md-4">
                                <div class="form-group row">
                                    <label for="pekerjaan_ibu" class="col-sm-3 col-form-label text-muted">Pekerjaan Ibu</label>
                                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group row">
                                    <label for="no_telpon_ayah" class="col-sm-3 col-form-label text-muted">No Telpon Ayah</label>
                                    <div class="col-sm-9">
                            ...
                            <div class="col-md-4">
                                <div class="form-group row">
                                    <label for="no_telpon_ibu" class="col-sm-3 col-form-label text-muted">No Telpon Ibu</label>
                                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group row">
                                    <label for="tanggal_bayar" class="col-sm-3 col-form-label text-muted">Tanggal Pembayaran Yang ditentukan</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="tanggal_bayar" value="<?= $data_pendaftar['tanggal_bayar'] ?>" class="form-control" style="background-color:#F0EBE3" id="tanggal_bayar" placeholder="dd/mm/yyyy" />
