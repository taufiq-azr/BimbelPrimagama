                ...
                <div class="col-12 grid-margin stretch-card main-panel">
                    <div class="card">
                        <div class="card-body" style="background-color: #1a242f;">
                            ...
                            <?php echo form_open("User/Upload_Gambar", array('enctype' => 'multipart/form-data')); ?>
                            <p class="card-description"> Data Pribadi </p>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="tanggal_bayar" class="col-sm-3 col-form-label text-light">Tanggal Bayar</label>
                                        <div class="col-sm-9">
                            ...
                            <div class="col-md-7">
                                    <div class="form-group row">
                                    <label for="gambar" class="col-sm-3 col-form-label text-light">Bukti Pembayaran</label>
