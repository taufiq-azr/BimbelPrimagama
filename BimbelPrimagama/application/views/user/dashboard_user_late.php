                ...
                <div class="col-12 grid-margin stretch-card main-panel ">
                    <div class="main-panel-wrapper">
                        <div class="row">
                            ...
                            <div class="col-12 grid-margin stretch-card" id="introduction">
                                <div class="card" >
                                    <div class="card-body" style="background-color: #1a242f;">
                                    <h3 class="mb-3 text-success">Selamat Datang Kembali</h3>
                                        <h5 class="mb-3 text-success">Terima Kasih Telah Menetapkan Tanggal Pembayaran ! </h5>
                                        <p class="text-light h6" ><strong>Tombol disamping digunakan untuk mendownload berkas yang berisi data calon siswa, Diharapkan Calon Siswa dapat membawa berkas tersebut, agar kami dapat melakukan registrasi ulang</strong></p>
                                       
                                    </div>
                                    <div class="modal-footer" style="background-color: #1a242f">
                                    <a href="<?= site_url('User/export/').$data_pendaftar[0]['id_pendaftar'] ?>" class="btn btn-primary">Cetak Form</a>
